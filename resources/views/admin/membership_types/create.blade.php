...
@section('page-title', 'Create New Membership Type')
    ...
    <div class="card">
        ...
        <form action="{{ route('admin.membership-types.store') }}" method="POST">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group mb-3">
                            ...
                            <input type="number" step="0.01" class="form-control @error('monthly_amount') is-invalid @enderror" id="monthly_amount" name="monthly_amount" value="{{ old('monthly_amount') }}">
                            <small class="form-text text-muted">Leave blank if not applicable. Must provide either monthly or annual.</small>
                    ...
                    <div class="col-md-6">
                        <div class="form-group mb-3">
                            ...
                            <input type="number" step="0.01" class="form-control @error('annual_amount') is-invalid @enderror" id="annual_amount" name="annual_amount" value="{{ old('annual_amount') }}">
                             <small class="form-text text-muted">Leave blank if not applicable. Must provide either monthly or annual.</small>
                 ...
                 <div class="form-group mb-3">
                    <label for="membership_duration">Membership Duration (e.g., "12 months", "1 month", "Lifetime")</label>
                    <input type="text" class="form-control @error('membership_duration') is-invalid @enderror" id="membership_duration" name="membership_duration" value="{{ old('membership_duration') }}" placeholder="e.g., 12 months">
            ...
            <div class="card-footer text-right">
                <button type="submit" class="btn btn-primary"><i class="fas fa-save"></i> Create Type</button>
