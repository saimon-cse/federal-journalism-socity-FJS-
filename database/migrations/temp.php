...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        Schema::create('allowance_types', function (Blueprint $table) {
            ...
            $table->text('details')->nullable(); // JSON array of criteria
...
Schema::create('training_instructors', function (Blueprint $table) {
    ...
    $table->foreignId('instructor_id')->comment('User ID of the instructor')->constrained('users')->cascadeOnDelete();
    $table->string('role_in_training')->nullable()->default('Instructor')->comment('e.g., Lead Instructor, Guest Speaker, Facilitator');
    $table->timestamps();
    $table->unique(['training_id', 'instructor_user_id'], 'training_instructor_unique');
});
...
Schema::create('training_invitations', function (Blueprint $table) {
    ...
    $table->foreignId('resource_person_id')->constrained('users')->cascadeOnDelete();
    ...
    $table->timestamps();
    $table->unique(['training_id', 'resource_person_user_id'], 'training_rp_invite_unique');
});
